...
class RequestDeserializerKtTest {
  ...
  fun deserializeTeamPreviewMessage() {
    ...
    Truth.assertThat(requestMessage).isInstanceOf(TeamPreviewRequest::class.java)

    val teamPreviewRequest = requestMessage as TeamPreviewRequest
    Truth.assertThat(teamPreviewRequest.name).isEqualTo("abraca001")
    Truth.assertThat(teamPreviewRequest.id).isEqualTo(Player.WHITE)
  }
}